...
await conn.send2ButtonImg(m.chat, await (await fetch('https://botcahx-rest-api.herokuapp.com/api/randomgambar/coffee')).buffer(),  '*────────[ DASBOARD ]────────*', text, 'INFOBOT', '.info', 'LISTMENU', '.menu', m, {  
      quoted: ftroli,  
